...
- Toot resolving does not work for some external instances - this is the same if you entered the toot URL in your home instance search manually and it won't return a result (for ex. local toots on toot.site)
